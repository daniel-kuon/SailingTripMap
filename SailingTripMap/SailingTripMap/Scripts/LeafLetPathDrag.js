//From: https://github.com/w8r/Leaflet.Path.Drag/blob/master/src/Path.Drag.js
...
L.Handler.PathDrag = L.Handler.extend( /** @lends  L.Path.Drag.prototype */ {
    ...
    _transformPoints: function(matrix) {
        ...
        var diff = transformation.untransform(px, scale)
            .subtract(transformation.untransform(L.point(0, 0), scale)); // console.time('transform');
